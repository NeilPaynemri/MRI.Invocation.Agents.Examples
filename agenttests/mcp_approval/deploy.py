...
Auto-generates a unique name like: invoketest1-mcp-v7-custom-a3f1
...
AGENT_PREFIX = "invoketest1-mcp"
DEFAULT_IMAGE = "faouwa1acr.azurecr.io/invoketest1-mcp2:v7-custom"
