...
Auto-generates a unique name like: invoketest1-mcp-agui-v4-custom-a3f1
...
Usage:
    ...
    python deploy.py --image ...:v4           # override image tag
"""
import argparse
import hashlib
import json
...
AGENT_PREFIX = "invoketest1-mcp-agui"
DEFAULT_IMAGE = "faouwa1acr.azurecr.io/invoketest1-mcp-approval-ag-ui:v4-custom"
MCP_SERVER_URL = "https://13v11bnq-8000.uks1.devtunnels.ms/mcp"
