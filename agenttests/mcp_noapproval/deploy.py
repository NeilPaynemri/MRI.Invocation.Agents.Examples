...
Auto-generates a unique name like: invoketest1-mcp-noap-v2-custom-a3f1
...
Usage:
    ...
    python deploy.py --image ...:v2           # override image tag
"""
import argparse
import hashlib
import json
...
AGENT_PREFIX = "invoketest1-mcp-noap"
DEFAULT_IMAGE = "faouwa1acr.azurecr.io/invoketest1-mcp-noaprov:v2-custom"
